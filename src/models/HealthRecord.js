module.exports = (sequelize, DataTypes) => {
    const HealthRecord = sequelize.define('HealthRecord', {
        ...
        record_type: {
            type: DataTypes.ENUM('vital_signs', 'lab_results', 'vaccination', 'prenatal', 'consultation', 'mental_health', 'physical_therapy', 'nutrition', 'birth_record', 'emergency'),
            allowNull: false
        },
        urgency_level: {
